...
export default function CTASparkles({
  ...
  return (
    <section className="relative flex h-[30rem] w-full flex-col items-center justify-center overflow-hidden rounded-md bg-card">
      ...
      <div className="relative z-10 px-4 text-center animate-fade-in-up">
        ...
        {description && <p className="mx-auto mt-4 max-w-xl text-sm text-foreground/70 md:text-lg">{description}</p>}
