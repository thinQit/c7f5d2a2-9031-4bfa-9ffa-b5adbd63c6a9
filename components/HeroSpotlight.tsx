...
export default function HeroSpotlight({
  headline = 'Big Deals. Fresh Drops. Everyday Essentials.',
  subheadline = 'Shop curated categories, unlock limited-time offers, and enjoy a smooth checkout experience built for modern shoppers.',
